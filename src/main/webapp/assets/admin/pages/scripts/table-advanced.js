...
var TableAdvanced = function() {
	...
	var initTable3 = function() {
		...
		function fnFormatDetails(oTable, nTr) {
			...
			var sOut = '<table>';
			sOut += '<tr><td>ID:</td><td>' + aData[2] + '</td></tr>';
			sOut += '<tr><td>Bio:</td><td>' + aData[3] + '</td></tr>';
	...
	var initTable4 = function() {
		...
		function fnFormatDetails(oTable, nTr) {
			...
			sOut += '<tr><td>First Name:</td><td>' + aData[3] + '</td></tr>'; 
			sOut += '<tr><td>Password:</td><td>' + aData[4] + '</td></tr>'; 
			sOut += '<tr><td>is emailActive:</td><td>' + aData[5] + '</td></tr>';
			sOut += '<tr><td>Others:</td><td>Could provide a link here</td></tr>';
			sOut += '</table>';
